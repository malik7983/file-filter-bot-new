...
async def advantage_spell_chok(msg):
    ...
    await msg.reply(script.Extra_TXT.format(message.from_user.mention if message.from_user else message.chat.title, temp.U_NAME, temp.B_NAME), reply_markup=reply_markup),
