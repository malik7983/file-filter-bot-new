...
/ytthumb https://youtu.be/yourlink"""
  ...
  இந்த பாட்டைப் பயன்படுத்த, எனது புதுப்பிப்புகள் சேனலில் சேரவும்...

ഈ ബോട്ട് ഉപയോഗിക്കുന്നതിന് എന്റെ അപ്‌ഡേറ്റ് ചാനലിൽ ചേരുക...

ਕਿਰਪਾ ਕਰਕੇ ਇਸ ਬੋਟ ਦੀ ਵਰਤੋਂ ਕਰਨ ਲਈ ਮੇਰੇ ਅਪਡੇਟਸ ਚੈਨਲ ਵਿੱਚ ਸ਼ਾਮਲ ਹੋਵੋ...

हमारे निचे दिए गये update चैनल को join करे जब तक आप हमारे update चैनल को join नहीं करेंगे तब तक bot आपको मूवी नहीं देगा.</b> 👇👇👇👇**"""
